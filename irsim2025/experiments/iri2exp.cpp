...
///*******************************************************************************/
//
CIri2Exp::CIri2Exp(const char* pch_name, const char* paramsFile) :
...
void CIri2Exp::AddActuators(CEpuck* pc_epuck)
{
...
void CIri2Exp::SetController(CEpuck* pc_epuck)
{
	char pchTemp[128];
