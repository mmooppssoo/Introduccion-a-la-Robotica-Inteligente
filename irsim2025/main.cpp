...
void RunEvolutionaryAlgorithm()
{
      ...
      unCurrentGeneration++)
  {
    ...
    printf("Generation %d - best fitness: %2.20f, average: %2.20f, worst: %2.20f                                                \n",
    ...
    if (g_bWriteToFiles)
    {
      ...
      */
      ...
      if (fileFitness == NULL)
      {
        ...
        fprintf(fileFitness, "%d \t %2.20f \t %2.20f \t %2.20f\n", unCurrentGeneration,
...
CPopulation* GetPopulation()
{
	...
	pcPopulation->SetCrossoverRate(1);
