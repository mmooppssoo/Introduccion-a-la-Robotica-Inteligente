#ifndef CTRNNDISTRIBUTEDCONTROLLER_H_
#define CTRNNDISTRIBUTEDCONTROLLER_H_
...
class CCTRNNDistributedController;
...
typedef vector<CCTRNNLayerController*>            TLayerVector;
typedef vector<CCTRNNLayerController*>::iterator  TLayerIterator;

/******************************************************************************/
/******************************************************************************/

class CCTRNNDistributedController : public CController
{
	public:
		CCTRNNDistributedController(const char* pch_name, CEpuck* pc_epuck,
